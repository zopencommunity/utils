...
# Inputs: 
#   - REPO :  Github repoistory to publish the artifact to e.g: https://github.com/ZOSOpenTools/xzport.git
#   - DESCRIPTION : Description of the tool that is presented in the Github release page
